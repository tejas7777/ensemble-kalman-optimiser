...
class ModelTrainer:
    def __init__(self, model, lr: float = 0.1, sigma: float = 0.01, k: int = 500, gamma: float = 0.1, max_iterations: Optional[int] = 1, loss_type: Optional[str] = 'mse', debug_mode = True):
        self.model = model
...
if __name__ == '__main__':
    ...
    model_trainer = ModelTrainer(model=model, lr=0.1, max_iterations=1, loss_type='mse', debug_mode=False)
