...
class GANTrainer:
    def __init__(self, gan_model, lr: float = 0.0002, latent_dim: int = 100):
        self.gan_model = gan_model
        self.latent_dim = latent_dim
        self.generator_optim = optim.Adam(gan_model.generator.parameters(), lr=lr, betas=(0.5, 0.999))
        self.discriminator_optim = optim.Adam(gan_model.discriminator.parameters(), lr=lr, betas=(0.5, 0.999))
    ...
    def save_model(self, filename=None):
        if filename is None:
            ...
            filename = f'gan_model_adam_{current_time}.pth'
